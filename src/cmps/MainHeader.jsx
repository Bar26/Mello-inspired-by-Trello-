...
export const SecondaryHeader = () => {
    ...
    return <header className='secondary-header flex'>
        <div className='flex'>
            ...
            <section className="nav-header flex">
                <div className='header-btn' style={{ width: '100%' }}>
                    <div className='button-top flex'>
                        <button className="secondary-header-button" onClick={() => toggleModal(refRecent)}>
                            <span>
                                Recent
                            </span>
                            ...
                            <ul>
                                {templates.map(template => {
                                    ...
                                    return <li key={utilService.makeId()} id={template.id} onClick={() => { onSelectTemplate(template._id) }}>
                                        ...
                                        <span className='header-star hide2'>{template.isStared && <i onClick={(event) => onSetStar(event, template)} className="fa-solid fa-star" style={{ color: 'yellow', '--fa-border-color': 'black' }}></i>}
                    ...
                    <div className='button-top flex'>
                        <button className="secondary-header-button" onClick={() => toggleModal(refStarred)}>
                            <span>
                                Starred
                            </span>
                            <i className="fa-solid fa-chevron-down"></i>
                        ...
                        <section ref={refStarred} className='header-modal starred hide'>
                            ...
                            <ul>
                                {templates.map(template => {
                                    // if (recentMap(template)) return <li key={utilService.makeId()} id={template.id} onClick={() => { onSelectTemplate(template._id) }}>
                                    if (template.isStared) return <li key={utilService.makeId()} id={template.id} onClick={() => { onSelectTemplate(template._id) }}>
                                        <div className='header-star-template'>
                                            <img className='template-img' src={template.img} />
                                            <span>{template.title}</span>
                                        </div>
                    ...
                    <div className='button-top flex'>
                        <button className="secondary-header-button" onClick={() => toggleModal(refTemplates)}>
                            <span>
                                Templates
                            </span>
                            <i className="fa-solid fa-chevron-down"></i>
